...
export const PRODUCERS = [
  ...
  { id: 'delfino-plaza', name: 'Delfino Fruit Market', kingdom: 'Isle Delfino', series: 'Sunshine', baseCost: '1.7e5', baseCps: '780', icon: 'delfino-plaza.webp', artMode: 'scenic', description: 'Sunshine, fruit stalls, and a municipal obsession with unusual plumbing.' },
