export const COSMETICS = [
  ...
  { id: 'backdrop-postcard', category: 'backdrop', name: 'Grand-Tour Postcard', cost: '0', preview: '▧', value: 'postcard', description: 'The sunny paper-and-stamps look that started the voyage.' },
  { id: 'backdrop-delfino', category: 'backdrop', name: 'Delfino Sunset', cost: '1e8', preview: '☀', value: 'delfino', description: 'Warm sea air, peach skies, and no visible court summons.' },
  { id: 'backdrop-battlefield', category: 'backdrop', name: 'Battlefield Dawn', cost: '1e16', preview: '⛰', value: 'battlefield', description: 'Green hills under a sky that has heard at least one cannon.' },
  { id: 'backdrop-comet', category: 'backdrop', name: 'Comet Night', cost: '1e28', preview: '☄', value: 'comet', description: 'Deep space with enough Luma glow to find the purchase buttons.' },
  { id: 'backdrop-neon', category: 'backdrop', name: 'New Donk Neon', cost: '1e42', preview: '▥', value: 'neon', description: 'Midnight skyscrapers powered by rhythm and municipal generators.' },
  { id: 'backdrop-rainbow', category: 'backdrop', name: 'Rainbow Road', cost: '1e58', preview: '⌁', value: 'rainbow', description: 'A guardrail-free spectrum running directly behind the paperwork.' },
  { id: 'backdrop-gloom', category: 'backdrop', name: 'Gloom Eclipse', cost: '1e74', preview: '◉', value: 'gloom', description: 'Purple moonlight for captains who find ordinary night insufficient.' },
