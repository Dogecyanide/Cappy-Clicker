...
- Rare clickable Shines appear during active play with five beneficial outcomes. Seven percent are cracked purple Gloom Shines with three serious penalties and a 4% chance of a one-hour Black Sun Jackpot; the exact result appears briefly beneath Cappy and clears with the effect. The Developer Lab can force every result.
- 29 permanent cosmetics across Cappy styles, fourteen distinct local-image voyage backdrops plus the route-following Grand-Tour Postcard, and sound packs.
