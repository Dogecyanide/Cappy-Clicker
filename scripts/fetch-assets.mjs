...
const assets = [
  ...
  ['public/assets/producers/new-donk-scooter.webp', wiki('Motor_Scooter_SMO.jpg'), 560],
  ...
  ['public/assets/producers/ruined-dragon.webp', wiki('Ruined_Dragon_Artwork_SMO.jpg'), 720],
